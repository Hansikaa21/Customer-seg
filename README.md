...
This project performs customer segmentation using the Customer Personality Analysis dataset. It uses Gaussian Mixture Models (GMM) to identify different customer groups based on demographics and spending behavior.
